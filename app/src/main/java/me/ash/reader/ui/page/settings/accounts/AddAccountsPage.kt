...
/*                item {
    ...
    AddLocalAccountDialog(navigateToAccountDetails)
    AddFeverAccountDialog(navigateToAccountDetails)
    AddGoogleReaderAccountDialog(navigateToAccountDetails)
    AddFreshRSSAccountDialog(navigateToAccountDetails)
}
